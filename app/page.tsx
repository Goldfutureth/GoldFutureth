...
export default function Home() {
  return (
    <main className="bg-slate-950 text-white min-h-screen flex flex-col items-center justify-center px-4 py-12">
      {/* Logo */}
      ...
      <div className="mt-10 text-center">
        ...
        <Image src="/line-qp.png" alt="Line QR" width={160} height={160} className="mx-auto" />
